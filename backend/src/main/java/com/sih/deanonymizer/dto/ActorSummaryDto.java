...
public class ActorSummaryDto {
    ...
    private List<String> associatedHandles = new ArrayList<>();
    ...
    public void setPersonaCount(int personaCount) { this.personaCount = personaCount; }

    public List<String> getAssociatedHandles() { return associatedHandles; }
    public void setAssociatedHandles(List<String> associatedHandles) { this.associatedHandles = associatedHandles; }
}
